...
gainXp(amount) {
        ...
        if (this.xp >= this.xpToNext) {
            ...
            // --- CHANGED: Trigger orbital upgrades every 5 levels (5, 10, 15...) ---
            else if (this.level % 5 === 0) {
                Game.active = false; // Pause
                // Update the text so it doesn't always say "LEVEL 5"
                document.querySelector('#upgradeMenu h1').innerText = `LEVEL ${this.level} REACHED!`;
